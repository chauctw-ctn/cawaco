...
module.exports = {
    ...
    telegram: {
        ...
        alertRepeatInterval: 60, // 60 phút - Chu kỳ nhắc lại cảnh báo cho các trạm vẫn offline (legacy)
        alertMinutes: [5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55], // Danh sách phút trong giờ khi gửi nhắc lại
